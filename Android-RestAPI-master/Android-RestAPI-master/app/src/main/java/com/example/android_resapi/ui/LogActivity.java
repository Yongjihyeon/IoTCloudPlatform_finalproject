    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startDateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(LogActivity.this, callbackMethod, 2023, 11, 0);
...
//                new GetLog(LogActivity.this,getLogsURL).execute();
                new GetLog(LogActivity.this,"https://b6xmw2wk0m.execute-api.ap-northeast-2.amazonaws.com/prod/devices/MyMKRWiFi1010/log").execute();
