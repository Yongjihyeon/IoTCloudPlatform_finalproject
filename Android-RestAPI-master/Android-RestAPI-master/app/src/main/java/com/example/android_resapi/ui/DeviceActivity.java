...
//                        new GetThingShadow(DeviceActivity.this, urlStr).execute();
                        new GetThingShadow(DeviceActivity.this, "https://b6xmw2wk0m.execute-api.ap-northeast-2.amazonaws.com/prod/devices/MyMKRWiFi1010").execute();
...
//                    }
                ...
                if (payload.length() >0 )
                    new UpdateShadow(DeviceActivity.this,"https://b6xmw2wk0m.execute-api.ap-northeast-2.amazonaws.com/prod/devices/MyMKRWiFi1010").execute(payload);
                else
